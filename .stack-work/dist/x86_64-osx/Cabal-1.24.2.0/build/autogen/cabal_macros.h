...
/* package living-spaces-0.1.0.0 */
#define VERSION_living_spaces "0.1.0.0"
#define MIN_VERSION_living_spaces(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "living-spaces-0.1.0.0"

#define CURRENT_PACKAGE_KEY "living-spaces-0.1.0.0"
